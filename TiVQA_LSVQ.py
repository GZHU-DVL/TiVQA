...
if __name__ == "__main__":
    parser = ArgumentParser(description='"EIVQA: Edge information boosts vqa"')
    ...
    if args.database == 'LSVQ':
        ...
        datainfo1 = '/home/zax/labels_train_test.csv'
        datainfo2 = '/home/zax/labels_test_1080p.csv'
    ...
    trained_model_file = 'models/{}-{}-EXP{}--{}--{}--{}--{}'.format(args.model, args.database, args.tau,args.beta, args.batch_size,'208_56','LBP_10_4')
    if not os.path.exists('results'):
        os.makedirs('results')
    save_result_file = 'results/{}-{}-EXP{}--{}--{}--{}--{}'.format(args.model, args.database, args.tau,args.beta, args.batch_size,'208_56','LBP_10_4')
    ...
    for epoch in range(args.epochs):
        ...
        if SROCC > best_test_criterion:
            print("EXP ID={}: Update best model using best_val_criterion in epoch {}".format(args.seed, epoch))
            if args.test_ratio > 0 and not args.notest_during_training:
